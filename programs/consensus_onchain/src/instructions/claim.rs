...
use solana_program::sysvar::instructions::{load_current_index_checked, load_instruction_at_checked, ID as IX_ID,};
...
pub fn claim(
    ...
    msg!("task: {}, nonce: {}, reward: {}, receiver: {}", claim_info.task, claim_info.nonce, claim_info.reward, claim_info.receiver.to_string());

    let owner = *ctx.accounts.payer.key;
    require!(
            owner == claim_info.receiver,
    ...
    require!(
            reward_info.times == claim_info.nonce,
